...
namespace TestMod.Source.Guns.Pieces.Yukari.DanmakuAbove
{
    public sealed class DanmakuAboveBPiece0Def : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(178003);
    ...
    public sealed class DanmakuAboveBPiece1Def : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(178003, 1);
            ...
            config.Color = new int[][] { new int[] { (int)BulletColor.Pink } };
    ...
    public sealed class DanmakuAboveBPiece2Def : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(178003, 2);
            ...
            config.GAngle = new float[][] { new float[] { -1f } };
