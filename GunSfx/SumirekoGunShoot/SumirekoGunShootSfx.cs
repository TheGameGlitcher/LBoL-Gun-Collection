...
{
    public sealed class SumirekoGunShootSfx : SfxTemplate
    {
        ...
        public override SfxConfig MakeConfig()
        {
            ...
            config.Name = "SumirekoGunShoot";

            config.Folder = "SFX";

            config.Path = "SumirekoGunShoot.wav";
        ...
        public override List<UniTask<AudioClip>> LoadSfxListAsync()
        {
            ...
            {
                ResourceLoader.LoadAudioClip("SumirekoGunShoot" + ".wav", AudioType.WAV, sfx_dir)
            };
        }
    }
}
