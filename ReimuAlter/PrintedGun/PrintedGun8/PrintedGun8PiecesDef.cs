...
namespace TestMod.Source.Guns.Pieces.PrintedGunPieces
{
    ...
    public sealed class PrintedGun8Piece1Def : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(90024, 1);
    ...
    public sealed class PrintedGun8Piece2Def : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(90024, 2);
            ...
            config.Radius = new float[][] { new float[] { 3.6f } };
            ...
            config.EvDuration = new int[][][] { new int[][] { new int[] { 65 } } };
    ...
    public sealed class PrintedGun8Piece0VFXPieceDef : TestModPiece
    {
        public override PieceConfig MakeConfig()
        {
            PieceConfig config = TestModDefaultConfig.DefaultPieceConfig();

            config.Id = ConvertGunId(90024, 3);

            config.Projectile = "Wave1s";
